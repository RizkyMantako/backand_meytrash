        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    Anda Dapat Melihat Riwayat Donasi.
                </p>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $xdonasi->no_hp }}</td>
                                            <td>
                                                <img src="{{ asset('storage/'.$xdonasi->foto_makanan) }}" class=" " width="100" height="130">
                                            </td>
                                            <td>{{ $xdonasi->berat_makanan }}kg</td>
                                            <td>{{ $xdonasi->jenis_makanan }}</td>
                                            <td>{{ $xdonasi->poin_transaksi }}</td>
                                            <td>{{ $xdonasi->created_at }}</td>
                                            <td>
                                                <div class="badge badge-meytrash">Selesai</div>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </table>
